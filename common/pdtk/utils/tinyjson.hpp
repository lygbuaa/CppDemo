...
namespace tiny {
	...
	*/
	...
	public:
		...
		std::string WriteJson(bool stdendl = true){
            return WriteJson(1, stdendl);
		}

        // 0: none  1: object  2: array
        std::string WriteJson(int type, bool stdendl = true);
    ...
    inline std::string TinyJson::WriteJson(int type, bool stdendl)
	{
