...
function(tbb_build)
    ...
    function(tbb_get_make_args)
        ...
        message(STATUS "tbb_GMA_USER_DEFINED_ARGS ${tbb_GMA_USER_DEFINED_ARGS}")
    ...
    elseif (CMAKE_SYSTEM_NAME MATCHES "Android")
        set(make_tool_name ${ANDROID_NDK_DIR}/ndk-build)
    endif()
    ...
    message(STATUS "#############TBB_MAKE_TOOL      ${TBB_MAKE_TOOL}")
    message(STATUS "#############tbb_make_args      ${tbb_make_args}")
    message(STATUS "#############tbb_build_cmd      ${tbb_build_cmd}")
    message(STATUS "#############tbb_build_TBB_ROOT ${tbb_build_TBB_ROOT}")
